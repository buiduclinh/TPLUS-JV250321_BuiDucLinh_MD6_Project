    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/api/auth/login", "/api/auth/verify", "/api/auth/me", "/api/auth/logout").permitAll()
                        .requestMatchers(HttpMethod.GET,"/api/users").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET,"/api/users/{user_id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST,"/api/users").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/api/users/{user_id}/role").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/api/users/{user_id}/status").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE,"/api/users/{user_id}/info").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST,"/api/courses/{course_id}/reviews").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.PUT,"/api/reviews/**").hasAnyRole("STUDENT", "ADMIN","TEACHER")
                        .requestMatchers(HttpMethod.DELETE,"/api/reviews/**").hasAnyRole("STUDENT", "ADMIN","TEACHER")
